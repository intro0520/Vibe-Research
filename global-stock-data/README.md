...
curl -o ~/.claude/skills/global-stock-data/SKILL.md \
  https://raw.githubusercontent.com/intro0520/global-stock-data/main/SKILL.md
...
> 想要什么数据端点？欢迎开 [Issue](https://github.com/intro0520/global-stock-data/issues) 提需求，赞助者的 Issue 优先处理。
